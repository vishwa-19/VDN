...
public class VerifyTotalContributedPublishedOnDikshaNotPublishedOnDiksha extends BaseClass{
	
	@Test
	public static void verifyTotalContributedPublishedOnDikshaNotPublishedOnDiksha() throws Exception {
