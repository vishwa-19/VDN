...
public class VerifyTheProjectDetailsPageOnContributor extends BaseClass {

	@Test
	public static void verifyTheProjectDetailsPageOnContributor() throws Exception {
	...
	VDNContributorMethods.validateTheProjectDetailsPageOnContributor(ProjectName);
