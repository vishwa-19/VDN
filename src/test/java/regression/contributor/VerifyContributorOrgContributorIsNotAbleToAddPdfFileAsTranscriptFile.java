...
public class VerifyContributorOrgContributorIsNotAbleToAddPdfFileAsTranscriptFile extends BaseClass {
	@Test
	public static void verifyContributorOrgContributorIsNotAbleToAddPdfFileAsTranscriptFile() throws Exception {
