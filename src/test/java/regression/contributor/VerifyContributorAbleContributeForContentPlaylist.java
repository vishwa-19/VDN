...
public class VerifyContributorAbleContributeForContentPlaylist extends BaseClass{
	
	@Test
	public static void verifyContributorAbleContributeForContentPlaylist() throws Exception {
	...
	UserOnBoarding.VDNlogout();
	UserOnBoarding.loginAsContributor("Ind Contributor");
	VDNContributorMethods.verifyContributorAbleContributeForContentPlaylist(ProjectName);
