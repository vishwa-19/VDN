...
public class VerifyContributedContentsPageIsAvailableInContributionDetailsSection extends BaseClass{
	
	@Test
	public static void verifyContributedContentsPageIsAvailableInContributionDetailsSection() throws Exception {
