...
public class VerifyAccessibilityDetailsButtonIsDisplayedInContentDetailsPage extends BaseClass {
	@Test
	public static void verifyAccessibilityDetailsButtonIsDisplayedInContentDetailsPage() throws Exception {
