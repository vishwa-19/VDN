...
public class VerifyContributorAbleToAddVideoAsSolutionInTheMCQQuestion extends BaseClass {
	@Test
	public static void verifyContributorAbleToAddVideoAsSolutionInTheMCQQuestion() throws Exception {
	...
	VDNContributorMethods.validateContributorAbleToAddVideoAsSolutionInTheMCQQuestion(ProjectName);
