...
public class VerifyEditDetailsFieldsArePopulatedFromEachPrimaryContentCategory extends BaseClass{
	
	@Test
	public static void verifyEditDetailsFieldsArePopulatedFromEachPrimaryContentCategory() throws Exception {
