...
public class VerifyContributorIsAbleToSelectCheckboxInTheAccessibilityDetailsPopUpAndSave extends BaseClass {
	@Test
	public static void verifyContributorIsAbleToSelectCheckboxInTheAccessibilityDetailsPopUpAndSave() throws Exception {
	...
	VDNContributorMethods.validateContributorIsAbleToSelectCheckboxInTheAccessibilityDetailsPopUpAndSave(ProjectName);
