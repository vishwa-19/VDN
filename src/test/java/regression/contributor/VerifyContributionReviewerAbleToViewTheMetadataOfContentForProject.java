...
public class VerifyContributionReviewerAbleToViewTheMetadataOfContentForProject extends BaseClass{
	
	@Test
	public static void verifyContributionReviewerAbleToViewTheMetadataOfContentForProject() throws Exception {
