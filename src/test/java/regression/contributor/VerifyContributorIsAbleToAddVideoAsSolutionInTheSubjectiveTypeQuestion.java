...
public class VerifyContributorIsAbleToAddVideoAsSolutionInTheSubjectiveTypeQuestion extends BaseClass {
	@Test
	public static void verifyContributorIsAbleToAddVideoAsSolutionInTheSubjectiveTypeQuestion() throws Exception {
	...
	VDNContributorMethods.validateContributorIsAbleToAddVideoAsSolutionInTheSubjectiveTypeQuestion(ProjectName);
