...
public class VerifyContributorOrgreviewerIsAbleToReviewContentAndDetailsInViewDetails extends BaseClass {
	@Test
	public static void verifyContributorOrgreviewerIsAbleToReviewContentAndDetailsInViewDetails() throws Exception {
		...
		VDNContributorMethods.validateContributorOrgreviewerIsAbleToReviewContentAndDetailsInViewDetails(ProjectName);
//		UserOnBoarding.VDNlogout();
	}
