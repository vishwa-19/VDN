...
public class VerifyContributionOrgReviewerIsAbleToRequestChangeCorrectedContent extends BaseClass {
	@Test
	public static void verifyContributionOrgReviewerIsAbleToRequestChangeCorrectedContent() throws Exception {
	...
	UserOnBoarding.VDNlogout();
	UserOnBoarding.loginAsContributor("Cont Only");
	VDNContributorMethods.validateContributionOrgReviewerIsAbleToRequestChangeCorrectedContent(ProjectName);
}
}
