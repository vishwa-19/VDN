...
public class VerifyAssignedReviewerIsAbleToSeeAnswerButtonForMCQ extends BaseClass {
	@Test
	public static void verifyAssignedProgramContributorAbleToUploadContentAndSubmitTheContentForReview() throws Exception {
	...
	VDNContributorMethods.validateAssignedReviewerIsAbleToSeeAnswerButtonForMCQ(ProjectName);
	}
