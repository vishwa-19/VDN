...
public class VerifyIndividualContributorAbleToUploadSavePreviewAndPublish extends BaseClass {
	@Test
	public static void verifyIndividualContributorAbleToUploadSavePreviewAndPublish() throws Exception {
	...
	UserOnBoarding.VDNlogout();
	UserOnBoarding.loginAsContributor("Ind Contributor");
	VDNContributorMethods.validateIndividualContributorAbleToUploadSavePreviewAndPublish(ProjectName);
