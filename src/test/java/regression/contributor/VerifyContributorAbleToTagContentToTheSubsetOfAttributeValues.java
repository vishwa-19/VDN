...
public class VerifyContributorAbleToTagContentToTheSubsetOfAttributeValues extends BaseClass{
	
	@Test
	public static void verifyContributorAbleToTagContentToTheSubsetOfAttributeValues() throws Exception {
