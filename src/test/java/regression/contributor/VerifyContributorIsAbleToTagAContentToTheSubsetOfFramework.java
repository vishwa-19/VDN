...
public class VerifyContributorIsAbleToTagAContentToTheSubsetOfFramework extends BaseClass{
	
	@Test
	public static void verifyContributorIsAbleToTagAContentToTheSubsetOfFramework() throws Exception {
