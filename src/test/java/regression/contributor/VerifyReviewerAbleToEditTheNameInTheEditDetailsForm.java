...
public class VerifyReviewerAbleToEditTheNameInTheEditDetailsForm extends BaseClass {
	@Test
	public static void verifyReviewerAbleToEditTheNameInTheEditDetailsForm() throws Exception {
