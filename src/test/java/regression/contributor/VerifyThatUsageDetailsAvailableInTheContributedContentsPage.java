...
public class VerifyThatUsageDetailsAvailableInTheContributedContentsPage extends BaseClass{
	
	@Test
	public static void verifyThatUsageDetailsAvailableInTheContributedContentsPage() throws Exception {
	...
	UserOnBoarding.VDNlogout();
	UserOnBoarding.loginAsContributor("Both Role");
	VDNContributorMethods.verifyThatUsageDetailsAvailableInTheContributedContentsPage(ProjectName);
	}
