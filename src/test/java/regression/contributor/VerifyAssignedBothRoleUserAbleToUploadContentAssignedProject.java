...
public class VerifyAssignedBothRoleUserAbleToUploadContentAssignedProject extends BaseClass {
	@Test
	public static void verifyAssignedBothRoleUserAbleToUploadContentAssignedProject() throws Exception {
	...
	VDNContributorMethods.validateAssignedBothRoleUserAbleToUploadContentAssignedProject(ProjectName);
