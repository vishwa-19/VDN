...
public class VerifyAllTheFrameworkAttributeValuesAreDisplayedInEditDetailsPopUp extends BaseClass{
	
	@Test
	public static void verifyAllTheFrameworkAttributeValuesAreDisplayedInEditDetailsPopUp() throws Exception {
