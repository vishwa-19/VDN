...
public class VerifyTheCountOnTOCandTopForContributionOgrContributor extends BaseClass {
	@Test
	public static void verifyTheCountOnTOCandTopForContributionOgrContributor() throws Exception {
	...
	VDNContributorMethods.validateTheCountOnTOCandTopForContributionOgrContributor();
	}
