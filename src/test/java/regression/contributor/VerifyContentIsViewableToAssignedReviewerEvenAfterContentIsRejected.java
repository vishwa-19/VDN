...
public class VerifyContentIsViewableToAssignedReviewerEvenAfterContentIsRejected extends BaseClass {
	@Test
	public static void verifyContentIsViewableToAssignedReviewerEvenAfterContentIsRejected() throws Exception {
	...
	UserOnBoarding.VDNlogout();
	UserOnBoarding.loginAsSourcing("Admin");
	VDNContributorMethods.verifyContentStatusRejecedForTheProject(ProjectName);
	UserOnBoarding.VDNlogout();
	UserOnBoarding.loginAsContributor("Rev Only");
	VDNContributorMethods.validateContentIsViewableToAssignedReviewerEvenAfterContentIsRejecte(ProjectName);
	}
