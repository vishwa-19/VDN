...
public class VerifyContributorAbleToUploadContentForFrameworkProject extends BaseClass{
	
	@Test
	public static void verifyContributorAbleToUploadContentForFrameworkProject() throws Exception {
