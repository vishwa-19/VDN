...
public class VerifyTheCountOnTocAndTopForUserWithBothRole extends BaseClass {
	@Test
	public static void verifyTheCountOnTocAndTopForUserWithBothRole() throws Exception {
