...
public class VerifyContentIsViewableToAssignedReviewerEvenAfterContentIsAccepted extends BaseClass {
	@Test
	public static void verifyContentIsViewableToAssignedReviewerEvenAfterContentIsAccepted() throws Exception {
	...
	UserOnBoarding.VDNlogout();
	UserOnBoarding.loginAsContributor("Rev Only");
	VDNContributorMethods.validateContentIsViewableToAssignedReviewerEvenAfterContentIsAccepted(ProjectName);
	}
