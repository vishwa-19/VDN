...
public class VerifyIndividualContributorNotAbleToContributeToTheClosedProjects extends BaseClass{
	
	@Test
	public static void verifyIndividualContributorNotAbleToContributeToTheClosedProjects() throws Exception {
		...
		UserOnBoarding.VDNlogout();
		UserOnBoarding.loginAsContributor("Cont Only");
		VDNContributorMethods.verifyIndividualContributorNotAbleToContributeToTheClosedProjects(ProjectName);
	}
