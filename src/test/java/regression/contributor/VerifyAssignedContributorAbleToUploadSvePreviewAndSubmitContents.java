...
public class VerifyAssignedContributorAbleToUploadSvePreviewAndSubmitContents extends BaseClass {
	@Test
	public static void verifyAssignedContributorAbleToUploadSvePreviewAndSubmitContents() throws Exception {
	...
	VDNContributorMethods.validateAssignedContributorAbleToUploadSvePreviewAndSubmitContents(ProjectName);
