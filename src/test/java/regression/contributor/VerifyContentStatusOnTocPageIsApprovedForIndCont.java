...
public class VerifyContentStatusOnTocPageIsApprovedForIndCont extends BaseClass {
	@Test
	...
	UserOnBoarding.VDNlogout();
	UserOnBoarding.loginAsContributor("Ind Contributor");
	VDNContributorMethods.verifyContentStatusOnTocPageIsApprovedForIndContributor(ProjectName);
