...
public class VerifyStatusOfContentWithViewCommentsDisplayedInTheContentPreviewPageForCorrectionsPending extends BaseClass {
	@Test
	public static void verifyStatusOfContentWithViewCommentsDisplayedInTheContentPreviewPageForCorrectionsPending() throws Exception {
	...
	UserOnBoarding.VDNlogout();
	UserOnBoarding.loginAsSourcing("Admin");
	VDNContributorMethods.verifyContentSendBackForTheCorrections(ProjectName);
	UserOnBoarding.VDNlogout();
	UserOnBoarding.loginAsContributor("Rev Only");
	VDNContributorMethods.validateStatusOfContentWithViewCommentsDisplayedInTheContentPreviewPageForCorrectionsPending(ProjectName);
	}
