...
public class VerifyContOrgContributorAbleToUploadContentAndAddAllDetails extends BaseClass {
	...
	public static void verifyContOrgContributorAbleToUploadContentAndAddAllDetails() throws Exception {
		...
		VDNContributorMethods.verifyContOrgContributorAbleToUploadContentAndAddAllDetails();
