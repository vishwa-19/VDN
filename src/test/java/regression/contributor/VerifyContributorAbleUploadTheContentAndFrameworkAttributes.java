...
public class VerifyContributorAbleUploadTheContentAndFrameworkAttributes extends BaseClass{
	
	@Test
	public static void verifyContributorAbleUploadTheContentAndFrameworkAttributes() throws Exception {
