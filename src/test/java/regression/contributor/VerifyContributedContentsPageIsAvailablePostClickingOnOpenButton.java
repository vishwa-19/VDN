...
public class VerifyContributedContentsPageIsAvailablePostClickingOnOpenButton extends BaseClass{
	
	@Test
	public static void verifyContributedContentsPageIsAvailablePostClickingOnOpenButton() throws Exception {
