...
public class VerifyContributorAbleToSelectAccessibleFeaturesUsingCheckbox extends BaseClass{
	
	@Test
	public static void verifyContributorAbleToSelectAccessibleFeaturesUsingCheckbox() throws Exception {
	...
	UserOnBoarding.VDNlogout();
	UserOnBoarding.loginAsContributor("Ind Contributor");
	VDNContributorMethods.verifyContributorAbleToSelectAccessibleFeaturesUsingCheckbox(ProjectName);
