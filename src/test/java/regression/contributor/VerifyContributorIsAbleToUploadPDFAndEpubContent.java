...
public class VerifyContributorIsAbleToUploadPDFAndEpubContent extends BaseClass {
	@Test
	public static void verifyContributorIsAbleToUploadPDFAndEpubContent() throws Exception {
