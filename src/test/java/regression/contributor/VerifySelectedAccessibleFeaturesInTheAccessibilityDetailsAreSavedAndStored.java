...
public class VerifySelectedAccessibleFeaturesInTheAccessibilityDetailsAreSavedAndStored extends BaseClass{
	
	@Test
	public static void verifySelectedAccessibleFeaturesInTheAccessibilityDetailsAreSavedAndStored() throws Exception {
