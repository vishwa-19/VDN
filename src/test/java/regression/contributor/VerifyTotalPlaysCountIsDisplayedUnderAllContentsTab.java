...
public class VerifyTotalPlaysCountIsDisplayedUnderAllContentsTab extends BaseClass{
	
	@Test
	public static void verifyTotalPlaysCountIsDisplayedUnderAllContentsTab() throws Exception {
