...
public class VerifyContributorAbleToUploadContentForLearningResource extends BaseClass {
	@Test
	public static void verifyContributorAbleToUploadContentForLearningResource() throws Exception {
	...
	VDNContributorMethods.uploadContentsFromContributorSideForLearningResource(ProjectName);
	}
