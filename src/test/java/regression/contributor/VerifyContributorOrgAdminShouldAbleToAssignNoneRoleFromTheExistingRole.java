...
public class VerifyContributorOrgAdminShouldAbleToAssignNoneRoleFromTheExistingRole extends BaseClass {
	@Test
	public static void verifyContributorOrgAdminShouldAbleToAssignNoneRoleFromTheExistingRole() throws Exception {
	...
	UserOnBoarding.VDNlogout();
	UserOnBoarding.loginAsContributor("Cont OrgAdmin");
	VDNContributorMethods.validateContributorOrgAdminShouldAbleToAssignNoneRoleFromTheExistingRole(ProjectName);
	}
