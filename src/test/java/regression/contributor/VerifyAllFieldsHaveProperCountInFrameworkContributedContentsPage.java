...
public class VerifyAllFieldsHaveProperCountInFrameworkContributedContentsPage extends BaseClass{
	
	@Test
	public static void verifyAllFieldsHaveProperCountInFrameworkContributedContentsPage() throws Exception {
