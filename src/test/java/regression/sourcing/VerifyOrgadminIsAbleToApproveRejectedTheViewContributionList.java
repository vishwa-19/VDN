...
public class VerifyOrgadminIsAbleToApproveRejectedTheViewContributionList extends BaseClass {
	@Test
	public static void verifyOrgadminIsAbleToApproveRejectedTheViewContributionList() throws Exception {
		...
		UserOnBoarding.VDNlogout();
		UserOnBoarding.loginAsSourcing("Admin");
		VDNSourcingMethods.verifySourcingOrgAdminIsAbleToApproveRejectContentFromWithoutTC(ProjectName);
	}
