...
public class VerifyReviewerAbleToEditTheNameOfTheContentAndSaveIt extends BaseClass{
	
	@Test
	public static void verifyReviewerAbleToEditTheNameOfTheContentAndSaveIt() throws Exception {
	...
	UserOnBoarding.VDNlogout();
	UserOnBoarding.loginAsSourcing("Admin");
	VDNSourcingMethods.verifyReviewerAbleToEditTheNameOfTheContentAndSaveIt(ProjectName);
