...
public class VerifyReviewerAbleToPublishTheContent extends BaseClass{
	
	@Test
	public static void verifyReviewerAbleToPublishTheContent() throws Exception {
	...
	VDNSourcingMethods.verifyReviewerAbleToPublishTheContent(ProjectName);
