...
public class VerifySourcingOrgAdminRejectTheContent extends BaseClass{
	
	@Test
	public static void verifySourcingOrgAdminRejectTheContent() throws Exception {
		...
		UserOnBoarding.VDNlogout();
		UserOnBoarding.loginAsSourcing("Admin");
		VDNSourcingMethods.verifySourcingOrgAdminRejectTheContent(ProjectName);
