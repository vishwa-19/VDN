...
public class VerifyPublishRejectedsendBackForCorrectionButtonNotAvailableForCloseProject extends BaseClass{
	
	@Test
	public static void verifyPublishRejectedsendBackForCorrectionButtonNotAvailableForCloseProject() throws Exception {
